#!/usr/bin/env python3
"""
Operating Simulator Web (CyberOS) - Yerel Geliştirme Sunucusu
...
class CustomHTTPHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        sys.stdout.write(f"[\033[96mCyberOS\033[0m] {self.address_string()} - {args[0]}\n")
...
def main():
    ...
    print("=" * 55)
    print("💻  \033[1mOperating Simulator Web (CyberOS) - Yerel Sunucu\033[0m")
    print("=" * 55)
    ...
    try:
        ...
        print("\n\n👋 CyberOS kapatıldı. İyi çalışmalar!")
        sys.exit(0)
